...
const page = {
  ...
  ResetPassword: () => import('./auth/reset-password/reset-password').then(m => m.ResetPassword),
  ...
  VendorAnalytics: () => import('./admin/vendor-analytics/vendor-analytics').then(m => m.VendorAnalytics),
  ...
  ContractList: () => import('./contracts/contract-list/contract-list').then(m => m.ContractList),
  ContractForm: () => import('./contracts/contract-form/contract-form').then(m => m.ContractForm),
  ContractDetails: () => import('./contracts/contract-details/contract-details').then(m => m.ContractDetails),
  ComplianceManagement: () => import('./contracts/compliance-management/compliance-management').then(m => m.ComplianceManagement),
...
export const routes: Routes = [
  ...
  {
    path: 'reset-password',
    loadComponent: page.ResetPassword
  },
  ...
  },
  {
    ...
    canActivate: [authGuard, roleGuard],
    data: { roles: ['Administrator', 'Procurement Manager', 'Supply Chain Manager', 'Finance Officer'] }
  },
  {
  ...
  { path: 'admin/vendor-analytics', loadComponent: page.VendorAnalytics, canActivate: [authGuard, roleGuard], data: { roles: ['Administrator'] } },
  ...
  { path: 'notification-center', loadComponent: page.Notifications, canActivate: [authGuard] },

  { path: 'contract-management', loadComponent: page.ContractList, canActivate: [authGuard, roleGuard], data: { roles: ['Administrator', 'Procurement Manager', 'Auditor'] } },
  { path: 'contract-management/add', loadComponent: page.ContractForm, canActivate: [authGuard, roleGuard], data: { roles: ['Administrator', 'Procurement Manager'] } },
  { path: 'contract-management/compliance', loadComponent: page.ComplianceManagement, canActivate: [authGuard, roleGuard], data: { roles: ['Administrator', 'Procurement Manager', 'Auditor'] } },
  { path: 'contract-management/edit/:id', loadComponent: page.ContractForm, canActivate: [authGuard, roleGuard], data: { roles: ['Administrator', 'Procurement Manager'] } },
  { path: 'contract-management/:id', loadComponent: page.ContractDetails, canActivate: [authGuard, roleGuard], data: { roles: ['Administrator', 'Procurement Manager', 'Auditor'] } },
  ...
  { path: 'finance/payment-details', loadComponent: page.PaymentDetails, canActivate: [authGuard, roleGuard], data: { roles: ['Finance Officer', 'Administrator'] } },
  { path: 'finance/purchase-orders', loadComponent: page.FinancePurchaseOrders, canActivate: [authGuard, roleGuard], data: { roles: ['Finance Officer', 'Administrator'] } },
