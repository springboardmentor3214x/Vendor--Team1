...
const PLACEHOLDER_PROCUREMENT_RISK_DASHBOARD_ROWS = [
...
function usePlaceholderProcurementRiskDashboard(rows: any[]): any[] {
  return rows && rows.length ? rows : PLACEHOLDER_PROCUREMENT_RISK_DASHBOARD_ROWS;
}
